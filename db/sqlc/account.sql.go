...
INSERT INTO accounts (
    ...
    $1, $2, $3
) RETURNING id, owener, balance, currceny, created_at
`

type CreateAccountParams struct {
	Owener   string `json:"owener"`
	Balance  int64  `json:"balance"`
	Currceny string `json:"currceny"`
}

func (q *Queries) CreateAccount(ctx context.Context, arg CreateAccountParams) (Accounts, error) {
	row := q.db.QueryRowContext(ctx, createAccount, arg.Owener, arg.Balance, arg.Currceny)
	var i Accounts
	err := row.Scan(
		&i.ID,
		&i.Owener,
...
SELECT id, owener, balance, currceny, created_at FROM accounts
WHERE id = $1 LIMIT 1
`
